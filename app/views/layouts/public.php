...
<body class="min-h-full flex flex-col bg-slate-50 text-slate-800 antialiased selection:bg-blue-600 selection:text-white">
    ...
    <!-- Top Corporate Header (Clean Modern Light Theme) -->
    <header class="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <a href="<?= url('/') ?>" class="flex items-center gap-3.5 group">
                <div class="w-11 h-11 rounded-2xl bg-gradient-to-tr from-blue-700 via-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-blue-600/20 font-extrabold text-lg tracking-wider group-hover:scale-105 transition-transform">
                    ICT
                </div>
                <div>
                    <div class="flex items-center gap-2">
                        <span class="text-base font-extrabold text-slate-900 tracking-tight uppercase">Helpdesk ICT</span>
                        <span class="px-2 py-0.5 text-[10px] font-bold bg-blue-100 text-blue-800 border border-blue-200 rounded-full font-mono">BKP</span>
                    </div>
                    <p class="text-xs text-slate-500 font-medium tracking-wide">Bahagian Khidmat Pengurusan</p>
                </div>
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?= url('/dashboard') ?>" 
                   class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-md shadow-blue-600/20 transition-all">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    <span>Papan Pemuka (<?= e(explode(' ', $currentUser['name'] ?? 'User')[0]) ?>)</span>
                </a>
                <?php else: ?>
                <a href="<?= url('/tickets/create') ?>" 
                   class="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold text-xs rounded-xl border border-blue-200 transition-all">
                ...
                <a href="<?= url('/login') ?>" 
                   class="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-xl shadow-sm transition-all">
    ...
    <!-- Public Footer -->
    <footer class="bg-slate-900 border-t border-slate-800 text-slate-400 text-xs py-12 mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-slate-800">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold text-base shadow-md">
                        ICT
                    </div>
                    <div>
